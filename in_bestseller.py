...
def Do_It(url):
    ...
    for book in books:
        ...
        name = book.find('div', class_='p13n-sc-truncate')
        try:
        ...
        try:
            urls.append("https://www.amazon.in/" + url['href'])
        except BaseException:
            urls.append(na)
...
Do_It("https://www.amazon.in/gp/bestsellers/books/")

Do_It("https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_2?ie=UTF8&pg=2")

Do_It("https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_3?ie=UTF8&pg=3")

Do_It("https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_4?ie=UTF8&pg=4")

Do_It("https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_5?ie=UTF8&pg=5")
